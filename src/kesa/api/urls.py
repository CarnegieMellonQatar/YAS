...
urlpatterns = [
	...
	url(r'^getBranch/(?P<sid>\d+)/$', views.getBranch, name='getBranch'),
    ...
    url(r'^getLikesStory/(?P<uid>\d+)/$', views.getLikesStory, name='getLikesStory'),
    ...
    url(r'^(?P<uid>\d+)/deleteBranch/(?P<sid>\d+)/$', views.deleteBranch, name='deleteBranch'),
    ...
    url(r'^(?P<uid>\d+)/addBReads/(?P<sid>\d+)/$', views.addBReads, name='addBReads'),
