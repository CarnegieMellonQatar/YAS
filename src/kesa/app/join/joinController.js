(function () {
    ...
    angular.module('kesaApp')
        .controller('joinController', function ($route, $routeParams, MiscService) {
            console.log("Join controller initialized to the ID " + $routeParams.joinID);
            var ctrl = this;

            ctrl.joinID = $routeParams.joinID;
